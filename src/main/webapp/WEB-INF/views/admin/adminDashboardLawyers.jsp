...
<head>
    ...
    <style>
        * {
        ...
        .lawyers-table tr:last-child td {
            border-bottom: none;
        }
        ...
        <div class="lawyers-section">
            ...
            <table class="lawyers-table">
                ...
                <tr>
                    ...
                    <td>
                        <img
                                src="${pageContext.request.contextPath}/assets/images/susasa-acharaya.png"
                ...
                <tr>
                    ...
                    <td>
                        <img
                                src="${pageContext.request.contextPath}/assets/images/anish-basnet.png"
