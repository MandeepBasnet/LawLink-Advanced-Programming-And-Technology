...
-- Check if gender column exists, if not add it with ENUM to match Clients table
...
INSERT INTO Users (username, password, email, full_name, phone, address, role, profile_image, is_active, date_of_birth) VALUES
    ('zaina.raj', '$2a$10$ICaBQFSL3IK5no59ZcmLo..CgrsXynJ5UTq5YmBS7HfxpT8S8tHfO', 'zaina.raj@lawlink.com', 'Zaina Raj', '+977-9086706541', 'Itahari', 'LAWYER', 'zaina.png', true, '1985-03-15'),
    ('rayan.rajbangsi', '$2a$10$ICaBQFSL3IK5no59ZcmLo..CgrsXynJ5UTq5YmBS7HfxpT8S8tHfO', 'rayan.rajbangsi@lawlink.com', 'Rayan Rajbangsi', '+977-9705523049', 'Itahari', 'LAWYER', 'rayan.png', true, '1978-07-22'),
    ('manish.khanal', '$2a$10$ICaBQFSL3IK5no59ZcmLo..CgrsXynJ5UTq5YmBS7HfxpT8S8tHfO', 'manish.khanal@lawlink.com', 'MANISH KHANAL', '+977-9812395010', 'Kathmandu', 'LAWYER', 'manish.png', true, '1982-11-10'),
    ('baviyan.koirala', '$2a$10$ICaBQFSL3IK5no59ZcmLo..CgrsXynJ5UTq5YmBS7HfxpT8S8tHfO', 'baviyan.koirala@lawlink.com', 'Baviyan Koirala', '+977-9867063791', 'Itahari', 'LAWYER', 'baviyan.png', true, '1980-05-30'),
    ('lalita.puri', '$2a$10$ICaBQFSL3IK5no59ZcmLo..CgrsXynJ5UTq5YmBS7HfxpT8S8tHfO', 'lalita.puri@lawlink.com', 'Lalita Puri', '+977-9706146926', 'Biratnagar', 'LAWYER', 'lalita.png', true, '1987-09-12'),
    ('ashutosh.srivastava', '$2a$10$ICaBQFSL3IK5no59ZcmLo..CgrsXynJ5UTq5YmBS7HfxpT8S8tHfO', 'ashutosh.srivastava@lawlink.com', 'Ashutosh Srivastava', '+977-9823543129', 'Morang', 'LAWYER', 'ashutosh.png', true, '1975-02-18'),
    ('yusha.shrestha', '$2a$10$ICaBQFSL3IK5no59ZcmLo..CgrsXynJ5UTq5YmBS7HfxpT8S8tHfO', 'yusha.shrestha@lawlink.com', 'Yusha Shrestha', '+977-9703304911', 'Tarahara', 'LAWYER', 'yusha.png', true, '1983-04-25'),
    ('anish.basnet', '$2a$10$ICaBQFSL3IK5no59ZcmLo..CgrsXynJ5UTq5YmBS7HfxpT8S8tHfO', 'anish.basnet@lawlink.com', 'Anish Basnet', '+977-9708203041', 'Jhapa', 'LAWYER', 'anish.png', true, '1979-08-05'),
    ('susasa.acharya', '$2a$10$ICaBQFSL3IK5no59ZcmLo..CgrsXynJ5UTq5YmBS7HfxpT8S8tHfO', 'susasa.acharya@lawlink.com', 'SUSASA ACHARYA', '+977-9703129941', 'Biratnagar', 'LAWYER', 'susasa.png', true, '1981-12-01');
...
INSERT INTO Users (username, password, email, full_name, phone, address, role, profile_image, is_active, date_of_birth) VALUES
    ('john.doe', '$2a$10$ICaBQFSL3IK5no59ZcmLo..CgrsXynJ5UTq5YmBS7HfxpT8S8tHfO', 'john.doe@example.com', 'John Doe', '+977-9812345670', 'Kathmandu', 'CLIENT', 'john.png', true, '1990-06-15'),
    ('jane.smith', '$2a$10$ICaBQFSL3IK5no59ZcmLo..CgrsXynJ5UTq5YmBS7HfxpT8S8tHfO', 'jane.smith@example.com', 'Jane Smith', '+977-9812345671', 'Pokhara', 'CLIENT', 'jane.jpg', true, '1988-03-22'),
    ('robert.wilson', '$2a$10$ICaBQFSL3IK5no59ZcmLo..CgrsXynJ5UTq5YmBS7HfxpT8S8tHfO', 'robert.wilson@example.com', 'Robert Wilson', '+977-9812345672', 'Lalitpur', 'CLIENT', 'robert.jpg', true, '1995-11-10'),
    ('sarah.johnson', '$2a$10$ICaBQFSL3IK5no59ZcmLo..CgrsXynJ5UTq5YmBS7HfxpT8S8tHfO', 'sarah.johnson@example.com', 'Sarah Johnson', '+977-9812345673', 'Bhaktapur', 'CLIENT', 'sarah.jpg', true, '1992-07-30'),
    ('michael.brown', '$2a$10$ICaBQFSL3IK5no59ZcmLo..CgrsXynJ5UTq5YmBS7HfxpT8S8tHfO', 'michael.brown@example.com', 'Michael Brown', '+977-9812345674', 'Dharan', 'CLIENT', 'michael.jpg', true, '1985-09-05');
...
VALUES
    ...
    ((SELECT user_id FROM Users WHERE username = 'zaina.raj'), (SELECT user_id FROM Users WHERE username = 'michael.brown'), '2025-05-04', '09:00:00', 60, 'COMPLETED', 'Property lease agreement review'),
    ...
    ((SELECT user_id FROM Users WHERE username = 'rayan.rajbangsi'), (SELECT user_id FROM Users WHERE username = 'sarah.johnson'), '2025-05-04', '10:00:00', 60, 'COMPLETED', 'Criminal case follow-up'),
    ...
    ((SELECT user_id FROM Users WHERE username = 'manish.khanal'), (SELECT user_id FROM Users WHERE username = 'jane.smith'), '2025-05-04', '11:00:00', 60, 'COMPLETED', 'Divorce settlement discussion'),
    ...
    ((SELECT user_id FROM Users WHERE username = 'baviyan.koirala'), (SELECT user_id FROM Users WHERE username = 'robert.wilson'), '2025-05-04', '12:00:00', 60, 'COMPLETED', 'Business incorporation advice'),
    ...
    ((SELECT user_id FROM Users WHERE username = 'lalita.puri'), (SELECT user_id FROM Users WHERE username = 'john.doe'), '2025-05-04', '13:00:00', 60, 'COMPLETED', 'International business contract consultation'),
...
-- Insert reviews for COMPLETED appointments before May 4, 2025
